...
const ProjectGrid = () => {
  ...
  animation: 'section-animation 10s ease infinite'}}><p 
            ...
            <br></br><a href="https://github.com/RolandosG/black_Jack_project" target="_blank" rel="noopener noreferrer"><SiGithub  size={'30px'}/>Github</a>
  ...
  animation: 'section-animation 10s ease infinite'}}><p 
            ...
            <br></br><a href="https://github.com/RolandosG/exploration-machine" target="_blank" rel="noopener noreferrer"><SiGithub  size={'30px'}/>Github</a>
  ...
  animation: 'section-animation 10s ease infinite'}}><p 
            class="card__body">A third person RPG adventure game made from scratch using unreals blueprints
             <br></br><a href="https://github.com/RolandosG/Rolos-Grand-Adventure" target="_blank" rel="noopener noreferrer"><SiGithub  size={'30px'}/>Github</a>
  ...
  backgroundSize: '240% 240%',
  animation: 'section-animation 10s ease infinite'}}><p 
            class="card__body">The website I've designed here. <br></br><a href="url">
           <SiGithub  size={'30px'}/>Github</a></p>
          </div>
    </div>
    </div>
   </div>
