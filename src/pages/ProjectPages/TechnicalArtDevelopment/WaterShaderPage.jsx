...
import './WaterShaderPage.css';

import wave1 from '../../../assets/mp4/wave1.gif';
import wave2 from '../../../assets/mp4/wave2.gif';
...
const GamblingPage = () => {
  ...
  const screenshots = [
    { src: wave2, description: 'Water simulation using grestner waves' },
  ...
  const achievements = [
    ...
    'Implemented a user-friendly parameters for easy interaction',
        ...
        <div className="hero-section">
          ...
          <div className="hero-content">
            ...
            <p className="hero-description">
              A showcase of advanced water shader techniques using Grestner waves in Unreal Engine 5.
            </p>
            
            <div className="role-badges">
          {['HLSL Developer', 'Designer', 'Programmer'].map((role, index) => (
        ...
        <div className="container-small">
          ...
          <div className="philosophy-grid">
            <div className="philosophy-card immersion">
              <h3>Immersion</h3>
              <p>
              Creating a realistic water simulation that enhances the player's immersion in the game world.
              </p>
            </div>
            ...
            <div className="philosophy-card agency">
              ...
              <p>
              Balancing complex water physics with a simple, intuitive user parameteres for easy interaction and adjustions.
              </p>
            </div>
            ...
            <div className="philosophy-card innovation">
              ...
              <p>
              Focusing on the small details that make the water simulation feel alive, such as realistic wave patterns and reflections.
              </p>
            </div>
            <div className="philosophy-card innovation">
              <h3>intricate challenges</h3>
              <p>
              Overcoming the challenges of real-time water rendering while maintaining performance and visual fidelity.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="section section-dark">
        <div className="container-small">
          ...
          <div className="video-info">
            <p>Development Timeline: January 2025 - March 2025</p>
            <div className="status-badges">
              <span className="status-badge complete">Complete</span>
              <span className="status-badge progress">Beta Release</span>
            </div>
          </div>
        </div>
      </section>
