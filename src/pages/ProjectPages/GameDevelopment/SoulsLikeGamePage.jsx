     ...
     <Header/>
        <div className="hero-section">
          ...
          <div 
            ...
            style={{
          backgroundImage: `url(${thirdRpgGif})`
            }}
          ></div>
          
          <div className="hero-content">
            <h1 className="hero-title">
            Souls-like Adventure Game
            </h1>
            <p className="hero-description">
            A 3rd person souls-like adventure game with challenging combat, atmospheric environments, and a focus on exploration.
            </p>
        ...
        <div className="container-small">
          ...
          <div className="philosophy-grid">
            <div className="philosophy-card immersion">
              ...
              <p>
              I prioritize creating a believable and engaging space combat world that draws players in and keeps them on edge.
              </p>
            </div>
...
export default SoulsLikeGamePage;