     ...
     <Header/>
        <div className="hero-section">
          ...
          <div 
            ...
            style={{
          backgroundImage: `url(${robotC})`
            }}
          ></div>
          
          <div className="hero-content">
            <h1 className="hero-title">
            Exploration Machine Robotics            
            </h1>
            <p className="hero-description">
            A project showcasing robotic sonar exploration and data analysis, designed to simulate a realistic robotics environment.
            </p>
            
            <div className="role-badges">
          {['Developer', 'Programmer'].map((role, index) => (
        ...
        <div className="container-small">
          ...
          <div className="philosophy-grid">
            <div className="philosophy-card immersion">
              <h3>Clear Code</h3>
              <p>
              Code that is easy to read and understand, making it accessible for future developers.
              </p>
            </div>
            ...
            <div className="philosophy-card agency">
              ...
              <p>
              A simple user interface that hides complex functionality, allowing users to focus on the task at hand.
              </p>
            </div>
            ...
            <div className="philosophy-card innovation">
              ...
              <p>
              Every aspect of the project is meticulously crafted, from the user interface to the underlying code.
              </p>
            </div>
            <div className="philosophy-card innovation">
              <h3>Robot Task</h3>
              <p>
              The robot is designed to relocate for certain tasks using sonar technology, showcasing its advanced capabilities.
              </p>
            </div>
          </div>
        </div>
