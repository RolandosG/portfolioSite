...
const CompareIlvlTooltip = () => {
  ...
  const technologies = [
    ...
    'World of Warcraft Community Engagement',
    'Add-on Distribution',
        ];
     ...
     <Header/>
        <div className="hero-section">
          ...
          <div 
            ...
            style={{
          backgroundImage: `url(${wowAddonImage})`
            }}
          ></div>
          
          <div className="hero-content">
            <h1 className="hero-title">
            Compare Item Level Tooltip
            </h1>
            <p className="hero-description">
              A World of Warcraft Addon that enhances the in-game item comparison experience by providing detailed item level tooltips, allowing players to make informed decisions about their gear FAST.
            </p>
            
            <div className="role-badges">
          {['Developer', 'Designer', 'Creator', 'Programmer'].map((role, index) => (
          ...
          <button className="btn-primary" onClick={() => window.open('https://www.curseforge.com/wow/addons/compareilvltooltip', '_blank')}>
            <Play />
            Visit App Site
          </button>
      ...
      <section className="section section-dark">
        <div className="container-small">
          ...
          <div className="video-info">
            <p>Development Timeline: September 2024 - October 2024</p>
...
export default CompareIlvlTooltip;