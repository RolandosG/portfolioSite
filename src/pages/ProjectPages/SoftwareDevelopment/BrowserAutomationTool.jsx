...
import './BrowserAutomationTool.css';
...
const BrowserAutomationTool = () => {
  ...
  const features = [
    {
      title: 'Simple to use with complexitity',
     ...
     <Header/>
        <div className="hero-section">
          ...
          <div 
            ...
            style={{
          backgroundImage: `url(${analyticspic})`
            }}
          ></div>
          ...
          <div className="hero-content">
            ...
            <p className="hero-description">
              A simple to use automation application to browse through media thoroughly. This tool is designed to automate the process of browsing and interacting with various media platforms, making it easier for users to access and manage their content efficiently.
            </p>
            
            <div className="role-badges">
          {['Developer', 'UI/UX Designer', 'Programmer'].map((role, index) => (
        ...
        <div className="container-small">
          ...
          <div className="philosophy-grid">
            <div className="philosophy-card immersion">
              <h3>Challenge</h3>
              <p>
              I wanted to challenge myself to create a tool that simplifies complex tasks while maintaining a user-friendly interface. The goal was to automate mundane browsing tasks, making it easier for users to focus on content rather than navigation.
              </p>
            </div>
            ...
            <div className="philosophy-card agency">
              ...
              <p>
              The design philosophy revolves around creating a simple yet powerful tool. The interface is designed to be intuitive, allowing users to easily navigate through features while still providing advanced functionalities for those who need them.
              </p>
            </div>
            ...
            <div className="philosophy-card innovation">
              ...
              <p>
              Every aspect of the tool, from the user interface to the underlying code, is crafted with meticulous attention to detail. This ensures a seamless user experience and high performance, making the tool reliable and efficient.
              </p>
            </div>
            <div className="philosophy-card innovation">
              <h3>intricate challenges</h3>
              <p>
              The project presented intricate challenges, such as ensuring cross-browser compatibility and implementing robust error handling. These challenges were met with innovative solutions, resulting in a tool that is both reliable and versatile.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="section section-dark">
        <div className="container-small">
          ...
          <div className="video-info">
            <p>Development Timeline: April 2024 - May 2024</p>
